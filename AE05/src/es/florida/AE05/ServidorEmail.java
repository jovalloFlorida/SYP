...
public class ServidorEmail {
	...
	public static void envioMail(String mensaje, String asunto, String email_remitente, String email_remitente_pass,
		...
		// para agregar más complementos al email, por ejemplo texto (.setText) y anexo,
		// creo una multipart
		...
		// ->Envío del mensaje mediante un objeto de tipo Transport soble la sesión
		// creada
	...
	public static void main(String[] args) {
		...
		String strMensaje = "AVERIA: Caldera con temperatura ERRONEA. La Temperatura no debe exceder de 50º o bajar de 1º ";
		...
		// JOptionPane.showConfirmDialog(null, pwd, "Introducir contraseña" ,
		// JOptionPane.OK_CANCEL_OPTION);
		// String emailRemitentePass = new String(pwd.getPassword());

		// Introducimos contraseña directamente en vez de pedirla por ventana emergente.
